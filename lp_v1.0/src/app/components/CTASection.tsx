    ...
    <section className="relative py-20 md:py-32 px-8 md:px-16 lg:px-24 bg-gradient-to-br from-[#2c4a5f] to-[#1e3340] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <button className="group relative px-10 py-5 rounded-full font-outfit text-base md:text-lg font-light text-white/70 bg-white/5 backdrop-blur-sm border border-white/20 hover:bg-white/10 hover:text-white/90 hover:border-white/30 transition-all duration-300 w-full sm:w-auto">
        ...
        >
          {/* 3D Visualization - Compact, minimal größer und kontrastreicher */}
          <div className="relative group w-[185px] md:w-[228px]">
            <div className="relative rounded-2xl overflow-hidden shadow-lg">
              <ImageWithFallback
                ...
                className="w-full h-[143px] md:h-[166px] object-cover contrast-[1.05]"
              />
              <div className="absolute bottom-3 left-3 right-3 bg-white/95 backdrop-blur-sm rounded-lg px-3 py-2">
                <p className="font-outfit text-xs font-semibold text-[#2c4a5f] text-center">
                  3D-Planung
                </p>
              </div>
            </div>
          ...
          {/* Arrow - größer und heller */}
          <ArrowRight className="w-9 h-9 text-[#e89a4d] flex-shrink-0 opacity-90" strokeWidth={2.5} />

          {/* Real Photo - Compact */}
          <div className="relative group w-[180px] md:w-[220px]">
            <div className="relative rounded-2xl overflow-hidden shadow-lg">
              <ImageWithFallback
