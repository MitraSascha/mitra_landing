      ...
      <div className="relative w-full px-8 md:px-16 lg:px-24 pb-20 md:pb-32">
        ...
        <div ref={textRef} className="max-w-4xl mb-16 md:mb-24">
          <div className="hero-text-part mb-2">
            <h1 className="font-outfit font-black text-[#e89a4d] tracking-tighter leading-[0.9] text-6xl md:text-8xl lg:text-9xl italic">
              Wie viele Tage
            </h1>
          </div>
        ...
        <div id="bad-quiz" className="max-w-5xl w-full">
          ...
          >
                ...
                <motion.button
                  ...
                  className={`text-left p-6 md:p-8 rounded-[2rem] border-2 transition-all duration-700 backdrop-blur-2xl ${
                    selectedAnswer === answer.id
                      ...
                      ? 'border-[#a8d4a8] bg-[#a8d4a8]/90 text-white shadow-2xl shadow-[#a8d4a8]/30'
                      : 'border-white/50 bg-white/30 text-white hover:border-white/70 hover:bg-white/40 hover:shadow-2xl'
            ...
            {/* Result Message - Stacked Cards Animation */}
            {showResult && (
              <div className="relative">
                {/* Card 1: Statistik Teil */}
                <motion.div
                  initial={{ opacity: 0, y: 60, scale: 0.9 }}
                  animate={{ opacity: 1, y: 0, scale: 1 }}
                  transition={{ duration: 0.8, delay: 0.2, ease: [0.34, 1.56, 0.64, 1] }}
                  className="relative z-10 p-8 md:p-10 rounded-[2rem] bg-gradient-to-br from-[#2c4a5f]/90 to-[#2c4a5f]/70 backdrop-blur-2xl border-2 border-white/30 shadow-2xl mb-6"
                >
                  {selectedAnswer === 'd' ? (
                    <p className="text-white text-xl md:text-2xl lg:text-3xl font-outfit font-black leading-tight">
                ...
                {/* Card 2: Urlaubstage Teil - stacked on top */}
                <motion.div
                  initial={{ opacity: 0, y: 40, scale: 0.95 }}
                  animate={{ opacity: 1, y: 0, scale: 1 }}
                  transition={{ duration: 0.8, delay: 0.5, ease: [0.34, 1.56, 0.64, 1] }}
                  className="relative z-20 p-8 md:p-10 rounded-[2rem] bg-gradient-to-br from-[#a8d4a8]/95 to-[#a8d4a8]/85 backdrop-blur-2xl border-2 border-white/40 shadow-2xl"
                >
