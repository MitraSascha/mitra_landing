...
export function QuizSection() {
  ...
  return (
    <section id="bad-quiz" className="min-h-screen flex items-center justify-center bg-[#FCFBF9] px-4 py-32">
      <div className="max-w-4xl w-full">
        ...
        >
          <h2 className="font-outfit text-2xl md:text-3xl font-semibold text-[#e89a4d] mb-12 tracking-tight">
            {question}
          </h2>
                ...
                className={`w-full text-left p-7 rounded-[2rem] border-2 transition-all duration-500 ${
                  selectedAnswer === answer.id
                    ? answer.isCorrect
                      ...
                      : 'border-[#CC5833] bg-[#CC5833]/10 text-[#2c4a5f]'
                    : showResult && answer.isCorrect
                    ? 'border-[#a8d4a8] bg-[#a8d4a8] text-white shadow-lg'
                    : 'border-[#2c4a5f] bg-[#2c4a5f] text-white hover:border-[#2c4a5f] hover:bg-[#2c4a5f]/90 hover:shadow-xl'
