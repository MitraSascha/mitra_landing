  ...
  return (
    <section className="relative py-24 md:py-32 px-8 md:px-16 lg:px-24 bg-gradient-to-br from-[#f5f1e8] via-[#e8dfd0] to-[#d4c9b8] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          {/* Button 1 - Kostenloses Beratungsgespräch - Orange */}
          <button className="group relative px-8 py-4 rounded-full font-outfit text-base md:text-lg font-semibold text-white bg-[#e89a4d] transition-all duration-300 hover:scale-105 hover:shadow-lg w-full sm:w-auto sm:flex-1 sm:max-w-xs overflow-hidden">
          ...
          {/* Button 2 - 3D Visualisierung buchen - Grün */}
          <button className="group relative px-8 py-4 rounded-full font-outfit text-base md:text-lg font-semibold text-white bg-[#a8d4a8] transition-all duration-300 hover:scale-105 hover:shadow-lg w-full sm:w-auto sm:flex-1 sm:max-w-xs overflow-hidden">
            <span className="relative z-10">3D Visualisierung buchen</span>
            {/* Animated shine effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
          </button>

          {/* Button 3 - Kontaktformular - Blau */}
          <button className="group relative px-8 py-4 rounded-full font-outfit text-base md:text-lg font-semibold text-white bg-[#2c4a5f] transition-all duration-300 hover:scale-105 hover:shadow-lg w-full sm:w-auto sm:flex-1 sm:max-w-xs overflow-hidden">
